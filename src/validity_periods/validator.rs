...
mod should {
    ...
    #[test]
    fn accept_because_child_validity_periods_are_subset_of_parent() {
    ...
    #[test]
    fn accept_because_child_validity_periods_are_the_same_as_parent() {
        let parent = &ValidityPeriods {
            not_before: dt("2000-01-01T00:00:00Z"),
            not_after: dt("2000-01-01T04:04:04Z"),
        };
    ...
    #[test]
    fn reject_timestamp_because_period_has_expired() {
    ...
    #[test]
    fn reject_timestamp_because_period_is_not_valid_yet() {
        let periods = &ValidityPeriods {
            not_before: dt("2000-01-01T01:01:01Z"),
            not_after: dt("2000-01-01T03:03:03Z"),
        };
    ...
    #[test]
    fn accept_timestamp_because_it_fits_periods() {
        let periods = &ValidityPeriods {
            not_before: dt("2000-01-01T01:01:01Z"),
            not_after: dt("2000-01-01T03:03:03Z"),
        };
    ...
    #[test]
    fn accept_timestamp_because_it_is_the_same_as_not_before() {
        let periods = &ValidityPeriods {
            not_before: dt("2000-01-01T01:01:01Z"),
            not_after: dt("2000-01-01T03:03:03Z"),
        };
    ...
    #[test]
    fn accept_timestamp_because_it_is_the_same_as_not_after() {
        let periods = &ValidityPeriods {
            not_before: dt("2000-01-01T01:01:01Z"),
            not_after: dt("2000-01-01T03:03:03Z"),
        };
